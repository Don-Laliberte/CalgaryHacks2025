...
import { useImageStore } from "../store"; // Import image modal state
import QuizItem from "../components/QuizItem";
import ImageModal from "../components/ClickableAssets/ImageModal";
...
const HomePage = () => {
  ...
  const { isImageOpen } = useImageStore(); // Image modal state
  ...
  return (
    <div className="home-container">
      ...
      {/* Show ImageModal when a ClickableImage is clicked */}
      <ImageModal />

      {/* Hide everything else when quiz OR image modal is open */}
      {!isOpen && !isImageOpen && (
